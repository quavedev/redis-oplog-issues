...
Tinytest.add(
  'livedata - sessionview - added a second field in another sub',
  function (test) {
    var v = newView(test);
...
Tinytest.add(
  'livedata - sessionview - change makes a new field',
  function (test) {
    var v = newView(test);
...
Tinytest.add(
  'livedata - sessionview - change to canonical value produces no change',
  function (test) {
    var v = newView(test);
...
Tinytest.add(
  'livedata - sessionview - new field of canonical value produces no change',
  function (test) {
    var v = newView(test);
...
Tinytest.add(
  'livedata - sessionview - clear all clears only once',
  function (test) {
    var v = newView(test);
...
Tinytest.add(
  'livedata - sessionview - change all changes only once',
  function (test) {
    var v = newView(test);
...
Tinytest.add(
  'livedata - sessionview - multiple operations at once in a change',
  function (test) {
    var v = newView(test);
    ...
    v.expectResult({
      fun: 'changed',
      id: 'A1',
      changed: { foo: 'baz', thing: 'stuff', baz: undefined },
    });
    v.expectNoResult();
...
Tinytest.add(
  'livedata - sessionview - more than one document',
  function (test) {
    var v = newView(test);
    ...
    v.expectResult({
      fun: 'changed',
      id: 'A1',
      changed: { thing: 'stuff', foo: undefined, baz: undefined },
    });
    v.expectNoResult();

...
export default class PubSubManager {
    ...
    _initMessageListener() {
        ...
        this.listener.on('message', Meteor.bindEnvironment(function(channel, _message) {
            advancedDebug({log: 'PubSubManager._initMessageListener on message', channel, _message});
            ...
            advancedDebug({log: 'PubSubManager._initMessageListener on message no channelHandlers', channel, _message });
        }));
    }
